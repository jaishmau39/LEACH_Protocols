...
r=0:rmax;
figure (1);
plot(r,STATISTICS.DEAD,'g');
hold off;
xlabel('Number of Rounds');
ylabel('Number of Dead Nodes')
title('Number of Dead Nodes')
legend('Mod-Leach','C-Leach','Leach','Location','best')

figure(2)
plot(r,STATISTICS.PACKETS_TO_BS,'g');
hold off;
title('Packets to Base Station')
legend('Mod-Leach','C-Leach','Leach','Location','northwest')

figure(7)
plot(r,STATISTICS.COUNTCHS,'g');
xlabel('Number of Rounds');
...
figure(4)
plot(r,STATISTICS.PACKETS_TO_CH,'g');
hold off;
title('Packets to Cluster Head')
legend('Mod-Leach','C-Leach','Leach','Location','best')

figure(5)
plot(r,STATISTICS.ALLIVE,'g');
hold off;
title('Number of Live Nodes')
legend('Mod-Leach','C-Leach','Leach')

%figure(10)
%plot(r,STATISTICS.ENERGY,'g');
