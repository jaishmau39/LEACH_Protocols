...
%function [STATISTICS2,FD2,TD2,AD2]=Leach_Centralized_graph(IniEng,NetSize,NoOfNode,NoOfRound,cluster_head_percentage)
...
figure (6);
plot(r,STATISTICS.COUNTCHS(r+1),'r');
%hold on;
%xlim([0 1000])
xlabel('Number of Rounds');
...
figure (4);
plot(r,STATISTICS.PACKETS_TO_CH(r+1));
hold on;
%xlim([0 1000])
xlabel('Number of Rounds');
